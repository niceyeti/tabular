...
// Op is a key and value describing an html-ele update.
// For example an html attribute and its new value.
type Op struct {
	Key   string
	Value string
}
...
type ViewComponent interface {
	...
	// Parse parses the view-component and adds it to the passed parent template, thus
	// inheriting or possibly extending its definition (func-map, etc). This allows
	// recursively definition view-components. Not sure this is the best design, but
	// 'works' a posteriori.
